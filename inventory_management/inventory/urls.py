...
urlpatterns = [
    ...
    # path('stock-reports/', stock_reports, name='stock_reports'),
    # path('product-report/', product_report, name='product_report'),
    # path('login-logout-report/', LoginLogoutReportView.as_view(template_name='inventory/logout.html'), name='login_logout_report'),
]
